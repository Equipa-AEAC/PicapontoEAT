...
/** A member is only an intern when an FCT internship has actually been assigned. */
  ...
  <section class="page-stack">
    ...
    <template v-else-if="membersStore.selectedMember">
      <section class="metric-grid">
        <BaseStatsCard label="Team hours" :value="String(membersStore.selectedMember.teamHours)" caption="Volunteer work — counts towards the surplus-hours certificate" />
        <BaseStatsCard v-if="isIntern" label="FCT hours completed" :value="String(membersStore.selectedMember.internshipCompletedHours)" caption="Internship only — separate from team hours" />
        <BaseStatsCard v-if="isIntern" label="FCT hours required" :value="String(membersStore.selectedMember.internshipRequiredHours)" caption="School requirement for the internship" />
        <BaseStatsCard v-if="isIntern" label="FCT hours remaining" :value="String(Math.max(membersStore.selectedMember.internshipRequiredHours - membersStore.selectedMember.internshipCompletedHours, 0))" caption="Hours left to complete the internship" />
      </section>
